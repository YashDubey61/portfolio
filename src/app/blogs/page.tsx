    ...
    <div className="min-h-screen w-full bg-white dark:bg-black relative overflow-x-hidden transition-colors duration-300">
      ...
      <div className="ml-0 mr-0 md:ml-[30%] md:mr-[30%] pt-[calc(22vh+112px)] pb-16 px-4 flex flex-col z-10 relative">
        <div className="relative pt-2 pb-6">
          ...
          {/* External Medium Link Card */}
          <div className="mt-8 pt-4">
            <a
              href="https://medium.com/@yashdubey"
              target="_blank"
              rel="noopener noreferrer"
              className="group relative flex items-center justify-between p-4 rounded-lg border border-black/10 dark:border-white/10 bg-zinc-50 dark:bg-[#0a0a0a] hover:bg-zinc-100 dark:hover:bg-[#121214] transition-colors"
            >
              <div className="flex flex-col gap-1">
                <span className="text-[14px] font-bold text-zinc-900 dark:text-zinc-100 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                  Read more on Medium
                </span>
                <span className="text-[12px] text-zinc-500 dark:text-zinc-400">
                  Follow @yashdubey on Medium for upcoming long-form articles
                </span>
              </div>
              <ExternalLink className="w-4 h-4 text-zinc-400 dark:text-zinc-500 group-hover:text-zinc-900 dark:group-hover:text-zinc-100 transition-colors shrink-0" />
            </a>
          </div>
        </div>
