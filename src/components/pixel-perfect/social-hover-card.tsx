...
const socialProfiles: Record<string, SocialProfile> = {
  GitHub: {
    name: "Yash Dubey",
    handle: "YashDubey61",
    avatar: "https://avatars.githubusercontent.com/u/184011651?v=4",
    bio: "B.Tech CSE (AI/ML) • AI/ML Developer & Builder",
    location: "Kanpur, Uttar Pradesh, India (UTC +05:30)",
    stats: [
  ...
  Twitter: {
    ...
    bio: "AI/ML Developer • Building practical AI systems & software products",
    location: "Kanpur, India (UTC +05:30)",
    stats: [],
  },
  LinkedIn: {
    name: "Yash Dubey",
    handle: "in/yash-dubey61",
    avatar: "https://avatars.githubusercontent.com/u/184011651?v=4",
    banner: darkBannerImage,
    bio: "B.Tech CSE (AI/ML) @ AKTU • AI/ML & Full-Stack Developer",
  ...
  Medium: {
    ...
    handle: "@yashdubey",
    avatar: "https://avatars.githubusercontent.com/u/184011651?v=4",
    bio: "Writing on AI systems, RAG architecture, LLMs, and full-stack engineering.",
    location: "Kanpur, India (UTC +05:30)",
    stats: [],
  },
};
