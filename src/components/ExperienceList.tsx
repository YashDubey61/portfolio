...
const experiences: ExperienceData[] = [
  {
    title: "Hackoverflow 4.0 (Team Pixels)",
    role: "Team Member & AI Developer",
    ...
    description: `
      ...
      Backend & Integration: Contributed to FastAPI backend endpoints, integrated biological datasets from ChEMBL and Open Targets, and generated 3D molecular structures
      Presentation: Delivered the final project architecture and live demonstration to jury panels and participants
    `,
    tech: [
      "Python",
      "FastAPI",
    ...
    metrics: [
      { label: "Project", value: "Pindora Shield" },
      { label: "Hackathon", value: "Hackoverflow 4.0" },
      { label: "Team", value: "Pixels" },
      { label: "Domain", value: "Healthcare AI" },
    ],
  },
  {
    title: "Odysis Group",
    role: "Digital Studio & Tech Initiative",
    dates: "2025 - Present",
    ...
    description: `
      ...
      Engineering: Building full-stack systems across React, TypeScript, FastAPI, Python, Flutter, and MongoDB
    `,
    tech: [
      "AI Systems",
      "React",
    ...
    metrics: [
      { label: "Initiative", value: "Studio" },
      { label: "Projects", value: "4+" },
      { label: "Tech", value: "AI + Web" },
      { label: "Focus", value: "Products" },
    ],
  },
  {
    title: "Dr. A.P.J. Abdul Kalam Technical University (AKTU)",
    role: "B.Tech Computer Science (AI/ML Specialization)",
    ...
    description: `
      ...
      Applied Learning: Actively participating in hackathons, the Python 100 Projects Challenge, and practical software engineering
    `,
    tech: [
      "Data Structures",
      "Algorithms",
                      ...
                      <div className="grid max-w-full grid-cols-2 pl-6 pr-8 2xl:grid-cols-4">
                        {item.metrics.map((metric) => (
                          ...
                          >
                            <p
                              className={`${
                                metric.value.includes(" - ") ? "text-[13px]" : "text-[16px]"
